...
public class MainResource {
	...
	private static final String myToken = "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";
	...
	public static void main(String[] args) {
		...
		if (gitHubAccessToken != null) {
			...
			logger.info(
					"========= You can provide your access token by CLI argument, like -DgithubToken=<YOUR_ACCESS_TOKEN> =========");
